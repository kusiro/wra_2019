...
<input type="checkbox" id="CB_rain_2016_06_28" onclick="toggle_rain_2016_06_28();" checked> 2016-06-28 豪雨災點<br/>
<input type="checkbox" id="CB_rain_2016_09_06" onclick="toggle_rain_2016_09_06();" checked> 2016-09-06 豪雨災點<br/>
<input type="checkbox" id="CB_rain_2016_10_06" onclick="toggle_rain_2016_10_06();" checked> 2016-10-06 豪雨災點<br/>
<input type="checkbox" id="CB_rain_2016_艾利" onclick="toggle_rain_2016_艾利();" checked> 2016 艾利<br/>
<input type="checkbox" id="CB_rain_2016_梅姬" onclick="toggle_rain_2016_梅姬();" checked> 2016 梅姬<br/>
<input type="checkbox" id="CB_rain_2016_莫蘭蒂" onclick="toggle_rain_2016_莫蘭蒂();" checked> 2016 莫蘭蒂<br/>
</div>
<div id="map"></div>
<script>
...
function initMap() {
	...
	while dr.read()
		...
		response.write("var marker_" & i & "=new google.maps.Marker({" & VBNewLine)
			...
			response.write("icon:{" & VBNewLine)
				response.write("path:my_airline_path," & VBNewLine)
				response.write("scale:0.4," & VBNewLine)
				response.write("strokeColor:'#FF0000'," & VBNewLine)
				response.write("strokeWeight:1," & VBNewLine)
				response.write("strokeOpacity:1," & VBNewLine)
