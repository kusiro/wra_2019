...
<asp:Content ID="input" ContentPlaceHolderID="input" runat="server">
    <input type="checkbox" id="CB_rain_2019_05_18" onclick="toggle_rain_2019_05_18();" checked> 2019-05-18 豪雨災點<br />
</asp:Content>
<asp:Content ID="script" ContentPlaceHolderID="script" runat="server">
        ...
        <%
            ...
            cmd.Connection=con
            cmd.CommandText="select * from rain_2019_05_18 where not isNull(lon);"
            ...
            while dr.read()
                ...
                response.write("markers_rain_2019_05_18.push(marker_" & i & ");" & VBNewLine)
                response.write(
...
<asp:Content ID="toggle" ContentPlaceHolderID="toggle" runat="server">
    var markers_rain_2019_05_18=[];

    function toggle_rain_2019_05_18() {
        if (document.getElementById('CB_rain_2019_05_18').checked) {
            for (var i=0;i < markers_rain_2019_05_18.length;i++) {
                markers_rain_2019_05_18[i].setMap(map);
            }
        }else{
            for (var i=0;i < markers_rain_2019_05_18.length;i++) {
                markers_rain_2019_05_18[i].setMap(null);
            }
        }
    }
</asp:Content>
