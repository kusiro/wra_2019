...
<input type="checkbox" id="CB_rain_2018_10_11" onclick="toggle_rain_2018_10_11();" checked> 2018-10-11 豪雨災點<br/>
...
function initMap() {
	...
	cmd.Connection=con
	cmd.CommandText="select * from rain_2018_10_11 where not isNull(lon);"
	...
	while dr.read()
		...
		response.write("markers_rain_2018_10_11.push(marker_" & i & ");" & VBNewLine)
...
<script>
function toggle_rain_2018_10_11() {
	if (document.getElementById('CB_rain_2018_10_11').checked) {
		for (var i=0;i < markers_rain_2018_10_11.length;i++) {
			markers_rain_2018_10_11[i].setMap(map);
		}
	}else{
		for (var i=0;i < markers_rain_2018_10_11.length;i++) {
			markers_rain_2018_10_11[i].setMap(null);
		}
	}
}
