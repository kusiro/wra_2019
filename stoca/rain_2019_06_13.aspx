...
<input type="checkbox" id="CB_rain_2019_06_13" onclick="toggle_rain_2019_06_13();" checked> 2019_06_13 豪雨災點<br/>
...
function initMap() {
    ...
    cmd.Connection=con
    cmd.CommandText = "select * from rain_2019_06_13 where not isNull(lon);"
    ...
    While dr.Read()
        ...
        Response.Write("markers_rain_2019_06_13.push(marker_" & i & ");" & vbNewLine)
...
<script>
    function toggle_rain_2019_06_13() {
    if (document.getElementById('CB_rain_2019_06_13').checked) {
        for (var i = 0; i < markers_rain_2019_06_13.length;i++) {
            markers_rain_2019_06_13[i].setMap(map);
		}
	}else{
        for (var i = 0; i < markers_rain_2019_06_13.length;i++) {
            markers_rain_2019_06_13[i].setMap(null);
		}
	}
}
