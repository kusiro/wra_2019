...
<asp:Content ID="input" ContentPlaceHolderID="input" runat="server">
    <input type="checkbox" id="CB_rain_2019_07_21" onclick="toggle_rain_2019_07_21();" checked> 2019-07-21 豪雨災點<br />
</asp:Content>
<asp:Content ID="script" ContentPlaceHolderID="script" runat="server">
        ...
        <%
            ...
            cmd.Connection=con
            cmd.CommandText="select * from rain_2019_07_21 where not isNull(lon);"
            ...
            while dr.read()
                ...
                response.write("markers_rain_2019_07_21.push(marker_" & i & ");" & VBNewLine)
...
<asp:Content ID="toggle" ContentPlaceHolderID="toggle" runat="server">
    ...
    var markers_rain_2019_07_21=[];
    function toggle_rain_2019_07_21() {
        if (document.getElementById('CB_rain_2019_07_21').checked) {
            for (var i=0;i < markers_rain_2019_07_21.length;i++) {
                markers_rain_2019_07_21[i].setMap(map);
            }
        }else{
            for (var i=0;i < markers_rain_2019_07_21.length;i++) {
                markers_rain_2019_07_21[i].setMap(null);
            }
        }
    }
</asp:Content>
