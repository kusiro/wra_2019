...
<div id="floating-panel">
    ...
    <form>
        start : <input type="date" value="2015-01-01" min="2015-01-01" name="start-time"><br/>
        end : <input type="date" value="2019-12-31" name="end-time">
        <input type="submit" >
    </form>
</div>
<div class="icon">
...
function initMap() {
	...
	<%
        ...
        If String.IsNullOrEmpty(Request.QueryString("start-time")) Then
            ...
            response.Write("console.log('" & startTime & "')" & vbNewLine)
        Else
