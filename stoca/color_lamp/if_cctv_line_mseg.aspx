<script runat="server">
    Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs)
        If not isPostBack Then
            ...
            cmd.CommandText = "select * from lineevent where aid=@aid"
            ...
            If dr.read() Then
                ...
                s = s & "<h3 style='line-height: 1.2em;margin: 0.2em 0;font-size: 16px;'>event_id: " & dr.Item("ID") & "</h1>"
                s = s & "<h3 style='line-height: 1.2em;margin: 0.2em 0;font-size: 16px;'>警示訊息時間: " & dr.Item("datetime") & "</h1>"
               
                s = s & "<table style:'border: 1px solid black;'>"
                s = s & "<tr style:'border: 1px solid black;'>"
                s = s & "<th style='line-height: 1.2em;border: 1px solid black;padding: 8px;margin: 0;'>flood_height</th>"
                s = s & "<th style='line-height: 1.2em;border: 1px solid black;padding: 8px;margin: 0;'>alert_level</th>"
                s = s & "</tr>"
                s = s & "<tr style:'border: 1px solid black;'>"
