...
<asp:Content ID="input" ContentPlaceHolderID="input" runat="server">
    <input type="checkbox" id="CB_rain_2019_05_20" onclick="toggle_rain_2019_05_20();" checked> 2019-05-20 豪雨災點<br />
</asp:Content>
<asp:Content ID="script" ContentPlaceHolderID="script" runat="server">
        ...
        <%
            ...
            cmd.Connection=con
            cmd.CommandText="select * from rain_2019_05_20 where not isNull(lon);"
            ...
            while dr.read()
                ...
                response.write("markers_rain_2019_05_20.push(marker_" & i & ");" & VBNewLine)
...
<asp:Content ID="toggle" ContentPlaceHolderID="toggle" runat="server">
    var markers_rain_2019_05_20=[];

    function toggle_rain_2019_05_20() {
        if (document.getElementById('CB_rain_2019_05_20').checked) {
            for (var i=0;i < markers_rain_2019_05_20.length;i++) {
                markers_rain_2019_05_20[i].setMap(map);
            }
        }else{
            for (var i=0;i < markers_rain_2019_05_20.length;i++) {
                markers_rain_2019_05_20[i].setMap(null);
            }
        }
    }
</asp:Content>
