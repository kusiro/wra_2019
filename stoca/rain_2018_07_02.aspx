...
<asp:Content ID="input" ContentPlaceHolderID="input" runat="server">
    <input type="checkbox" id="CB_rain_2018_07_02" onclick="toggle_rain_2018_07_02();" checked> 2018-07-02 豪雨災點<br />
</asp:Content>
<asp:Content ID="script" ContentPlaceHolderID="script" runat="server">
        ...
        <%
            ...
            cmd.Connection=con
            cmd.CommandText="select * from rain_2018_07_02 where not isNull(lon);"
            ...
            while dr.read()
                ...
                response.write("markers_rain_2018_07_02.push(marker_" & i & ");" & VBNewLine)
...
<asp:Content ID="toggle" ContentPlaceHolderID="toggle" runat="server">
    var markers_rain_2018_07_02=[];

    function toggle_rain_2018_07_02() {
        if (document.getElementById('CB_rain_2018_07_02').checked) {
            for (var i=0;i < markers_rain_2018_07_02.length;i++) {
                markers_rain_2018_07_02[i].setMap(map);
            }
        }else{
            for (var i=0;i < markers_rain_2018_07_02.length;i++) {
                markers_rain_2018_07_02[i].setMap(null);
            }
        }
    }
</asp:Content>
