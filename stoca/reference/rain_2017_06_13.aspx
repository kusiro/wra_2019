...
<input type="checkbox" id="CB_rain_2017_06_13" onclick="toggle_rain_2017_06_13();" checked> 2017-06-13 豪雨災點<br/>
...
function initMap() {
    ...
    cmd.Connection=con
    cmd.CommandText="select * from rain_2017_06_13 where not isNull(lon);"
...
<script>
function toggle_rain_2017_06_13() {
	if (document.getElementById('CB_rain_2017_06_13').checked) {
		for (var i=0;i < markers_rain_2017_06_13.length;i++) {
			markers_rain_2017_06_13[i].setMap(map);
		}
	}else{
		for (var i=0;i < markers_rain_2017_06_13.length;i++) {
			markers_rain_2017_06_13[i].setMap(null);
		}
	}
}
