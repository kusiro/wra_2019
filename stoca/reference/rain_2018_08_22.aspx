...
<input type="checkbox" id="CB_rain_2018_08_22" onclick="toggle_rain_2018_08_22();" checked> 2018-08-22 豪雨災點<br/>
...
function initMap() {
    ...
    cmd.Connection=con
    cmd.CommandText="select * from rain_2018_08_22 where not isNull(lon);"
    ...
    while dr.read()
        ...
        response.write("markers_rain_2018_08_22.push(marker_" & i & ");" & VBNewLine)
...
<script>
function toggle_rain_2018_08_22() {
	if (document.getElementById('CB_rain_2018_08_22').checked) {
		for (var i=0;i < markers_rain_2018_08_22.length;i++) {
			markers_rain_2018_08_22[i].setMap(map);
		}
	}else{
		for (var i=0;i < markers_rain_2018_08_22.length;i++) {
			markers_rain_2018_08_22[i].setMap(null);
		}
	}
}
