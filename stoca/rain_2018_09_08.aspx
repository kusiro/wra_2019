...
<asp:Content ID="input" ContentPlaceHolderID="input" runat="server">
    <input type="checkbox" id="CB_rain_2018_09_08" onclick="toggle_rain_2018_09_08();" checked> 2018-09-08 豪雨災點<br />
</asp:Content>
<asp:Content ID="script" ContentPlaceHolderID="script" runat="server">
        ...
        <%
            ...
            cmd.Connection=con
            cmd.CommandText="select * from rain_2018_09_08 where not isNull(lon);"
            ...
            while dr.read()
                ...
                response.write("markers_rain_2018_09_08.push(marker_" & i & ");" & VBNewLine)
                response.write(
...
<asp:Content ID="toggle" ContentPlaceHolderID="toggle" runat="server">
    var markers_rain_2018_09_08=[];

    function toggle_rain_2018_09_08() {
        if (document.getElementById('CB_rain_2018_09_08').checked) {
            for (var i=0;i < markers_rain_2018_09_08.length;i++) {
                markers_rain_2018_09_08[i].setMap(map);
            }
        }else{
            for (var i=0;i < markers_rain_2018_09_08.length;i++) {
                markers_rain_2018_09_08[i].setMap(null);
            }
        }
    }
</asp:Content>
