...
<asp:Content ID="script" ContentPlaceHolderID="script" runat="server">
    ...
    <%
        ...
        cmd.Connection=con
        cmd.CommandText="select * from rain_2019_丹娜絲 where not isNull(lon);"
        ...
        while dr.read()
            ...
            response.write("markers_rain_2019_丹娜絲.push(marker_" & i & ");" & VBNewLine)
                response.write(
...
<asp:Content ID="toggle" ContentPlaceHolderID="toggle" runat="server">
    ...
    var markers_rain_2019_丹娜絲=[];
    function toggle_rain_2019_丹娜絲() {
        if (document.getElementById('CB_rain_2019_丹娜絲').checked) {
            for (var i=0;i < markers_rain_2019_丹娜絲.length;i++) {
                markers_rain_2019_丹娜絲[i].setMap(map);
            }
        }else{
            for (var i=0;i < markers_rain_2019_丹娜絲.length;i++) {
                markers_rain_2019_丹娜絲[i].setMap(null);
            }
        }
    }
</asp:Content>
