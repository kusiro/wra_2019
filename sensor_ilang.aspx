...
function initMap() {
	...
	con=nothing
	%>
	var markerCluster=new MarkerClusterer(map,markers_sensor_ilang,{imagePath: 'https://developers.google.com/maps/documentation/javascript/examples/markerclusterer/m'});
}
</script>
